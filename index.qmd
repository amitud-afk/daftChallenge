...
# Example of a professionally styled node with diagonal connection
...
# Example of a professionally styled node with diagonal connections
...
pgm.add_node("bacteria", "Bacteria in Food", 2.5, 1.5, aspect = 3, scale = 1.1,
             plot_params={
...
pgm.add_node("scurvy", "Scurvy", 4, .5, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': 'thistle', 
                 'edgecolor': 'black', 
                 'linewidth': 2,
...
plt.title("Updated Bacterial Theory (Late 19th Century)", fontsize=14)
...
# Example of a professionally styled node with diagonal connections
pgm.add_node("vitamin", "Vitamin C", 1, 2.5, aspect = 3, scale = 1.1,
             plot_params={
                 'facecolor': 'yellow', 
                 'edgecolor': 'black', 
                 'linewidth': 2,
...
pgm.add_node("collagen", "Collagen Synthesis", 2.5, 1.5, aspect = 4, scale = 1.1,
             plot_params={
                 'facecolor': 'lightblue', 
                 'edgecolor': 'darkred', 
                 'linewidth': 2,
...
plt.title("Simplified Modern Understanding (1930s onwards)", fontsize=14)
